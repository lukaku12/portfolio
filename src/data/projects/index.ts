...
export const PROJECT_DATA: Project[] = [
    {
        ...
        website: "",
        start_date: new Date("02-02-2022").toLocaleDateString(),
        end_date: new Date("02-04-2022").toLocaleDateString(),
    },
    {
        id: 2,
        title: "SocialSync",
        ...
        website: "",
        start_date: new Date("02-04-2024").toLocaleDateString(),
        end_date: "",
    },
    {
        id: 3,
        ...
        start_date: new Date("03-23-2024").toLocaleDateString(),
        end_date: new Date("04-12-2024").toLocaleDateString(),
    ...
    },
    {
        ...
        status: status.completed,
        start_date: new Date("06-23-2022").toLocaleDateString(),
        end_date: new Date("03-15-2023").toLocaleDateString(),
        main_technologies: [technologies.laravel, technologies.vue],
        technologies: {
            [Technologies.vue]: technologies.vue,
            [Technologies.laravel]: technologies.laravel,
    ...
    },
    {
        ...
        status: status.completed,
        start_date: new Date("03-23-2023").toLocaleDateString(),
        end_date: new Date("06-15-2023").toLocaleDateString(),
        main_technologies: [technologies.laravel, technologies.react],
        technologies: {
            [Technologies.react]: technologies.react,
            [Technologies.laravel]: technologies.laravel,
    ...
    },
    {
        ...
        status: status.completed,
        start_date: new Date("03-24-2023").toLocaleDateString(),
        end_date: new Date("04-10-2023").toLocaleDateString(),
    ...
    },
    {
        ...
        website: "",
        status: status.completed,
        start_date: new Date("05-14-2022").toLocaleDateString(),
        end_date: new Date("06-03-2022").toLocaleDateString(),
    },
    {
        id: 8,
        title: "Shopping Cart",
        ...
        status: status.completed,
        start_date: new Date("10-11-2023").toLocaleDateString(),
        end_date: new Date("10-24-2023").toLocaleDateString(),
    ...
    },
    {
        ...
        status: status.completed,
        start_date: new Date("04-11-2022").toLocaleDateString(),
        end_date: new Date("04-24-2022").toLocaleDateString(),
    ...
    },
    {
        ...
        status: status.completed,
        start_date: new Date("09-10-2023").toLocaleDateString(),
        end_date: new Date("09-24-2023").toLocaleDateString(),
        main_technologies: [technologies.html, technologies.javascript],
        technologies: {
            [Technologies.css]: technologies.css,
            [Technologies.html]: technologies.html,
