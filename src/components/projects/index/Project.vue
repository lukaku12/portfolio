<template>
  <div class="mb-5">
    ...
    <div class="my-3 text-bodyText">
      ...
      <span
          class="!pt-[1.313rem] !pb-[1.813rem] !h-full text-secondary-blue text-codeSnippet">
        {{ project.tag }}
      </span>
    </div>
    ...
    <v-card class="max-w-[368px] h-[331px] max-h-[331px] !bg-primary-darker-gray border !rounded-lg">
      <div class="relative">
        ...
        <v-img
            class="w-full !max-h-[145px] max-w-[368px]"
            height="145"
            cover
        ...
        <div class="absolute right-3 top-3 flex gap-x-1">
          <v-card
              v-for="technology in project.main_technologies"
              :key="technology.id"
